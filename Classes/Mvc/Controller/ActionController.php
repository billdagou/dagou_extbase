...
class ActionController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
     ...
     */
    public function addExternalFlashMessage(string $extensionName, string $pluginName, string $messageBody, string $messageTitle = '', ContextualFeedbackSeverity $severity = ContextualFeedbackSeverity::OK, bool $storeInSession = TRUE): void {
     ...
     */
    protected function setTypeConverterConfigurationForFileUpload(string $argumentName, string $propertyName, array $overrideConfiguration = []): void {
        $configuration = [
            UploadedFileReferenceConverter::CONFIGURATION_ALLOWED_FILE_EXTENSIONS => $overrideConfiguration['extensions'] ?? $this->settings[$propertyName]['ext'] ?? $GLOBALS['TYPO3_CONF_VARS']['GFX']['imagefile_ext'],
